...
import (
	...
	gaiafeeante "github.com/White-Whale-Defi-Platform/migaloo-chain/v3/x/globalfee/ante"
	globfeetypes "github.com/White-Whale-Defi-Platform/migaloo-chain/v3/x/globalfee/types"
)
...
func (s *IntegrationTestSuite) TestGetDefaultGlobalFees() {
	...
	// setup antehandler
	mfd := gaiafeeante.NewFeeDecorator(migalooapp.GetDefaultBypassFeeMessages(), globalfeeSubspace, stakingSubspace, newTestGasLimit())
